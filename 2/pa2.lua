...
--- 02/11/20
--- pa2.lua
--- purpose: completes assignment 2
local pa={}

--- filteres elements in table by fn
...
--- returns iterator to all substrings of str
